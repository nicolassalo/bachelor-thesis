...
public interface ReviewRepository extends JpaRepository<Review, Long> {
    ...
    List<Review> findByIdInAndLangAndIsForTraining(List<Long> ids, String lang, boolean forTraining);
    List<Review> findByLangAndPersonaAndIsForTraining(String lang, String persona, boolean forTraining);
    List<Review> findByLangAndPersonaNotAndIsForTraining(String lang, String persona, boolean forTraining);
